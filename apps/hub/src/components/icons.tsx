...
export function HqIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <rect x="3.5" y="4" width="17" height="16" rx="2" strokeLinejoin="round" />
      <path d="M3.5 9h17M8 4v3M16 4v3" strokeLinecap="round" strokeLinejoin="round" />
      <path d="M7.5 13h3M7.5 16.5h5M13.5 13h3" strokeLinecap="round" />
    </svg>
  );
}
...
export function BuilderIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.6} {...props}>
      <path
        d="M14.5 3.5 20.5 9.5 9.5 20.5 3.5 14.5Z"
        strokeLinecap="round"
        strokeLinejoin="round"
      />
      <path d="M9 9 15 15" strokeLinecap="round" />
    </svg>
  );
}
